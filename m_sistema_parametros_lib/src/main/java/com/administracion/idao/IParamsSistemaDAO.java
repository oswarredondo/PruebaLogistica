 ...
 *
 */
public interface IParamsSistemaDAO {

	
	/**
	 * Obtiene los datos de la propiedad solicitada, Entre las pripiedades
	 * existentes estan: <b>PathLogosEtiqueta</b>= Contiene el path f�sico donde
	 * se encuentran almacenadas las imagenes que son configuradas en la
	 * rotulaci�n o importaci�n de una etiqueta <b>Debug</b>= indica si se deben
...
//	public float  getValorPropiedadFloat(String idparametro, String idsistema)throws Exception;
//	public float  getValorPropiedadFloat(int idconvenio)throws Exception;
	public List<SistemaDTO>  getValorPropiedadFloat(int idconvenio)throws Exception;
	 ...
	 * los documentos, imagenesm que ser�n asociados a un cliente y usuario,
