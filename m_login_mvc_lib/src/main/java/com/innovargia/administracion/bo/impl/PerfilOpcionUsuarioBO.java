...
public class PerfilOpcionUsuarioBO implements IPerfilOpcionUsuarioBO {
	...
	@Override
	public PerfilOpcionDTO getModulosOpcionesPerfilAccesoWin(
		UsuarioDTO usuario, String idmodulo) throws Exception {
	    // TODO Auto-generated method stub
	    return iPerfilOpcionUsuarioDAO.getModulosOpcionesPerfilAccesoWin(usuario, idmodulo);
	}
