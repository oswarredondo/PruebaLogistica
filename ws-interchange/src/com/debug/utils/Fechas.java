...
public class Fechas {
    ...
    /**
     * Suma dias,meses o años a una instancia de Calendar y regresa una cadena con el
     * formato indicado.<br>
     *
    ...
    /**
     * Obtiene el día de la fecha para poder desplegarlo en la pantalla.
    ...
    public static String obtenDia(String dFecha,int iCantidad, String formato) {
        ...
        //Obtiene el día mes y año de la fecha pasada como
        //parametro
    ...
    /**
     * Regresa  la fecha del día actual en formato dd.MM.yyyy hh:mm aaa
     * @return
     */
    ...
    /**
     * Devuelve la fecha en formato de texto, en español, si se pasa la fecha de
    ...
    public static String fechaTexto(Calendar fecha, boolean isEspanol){
        //Formato en espanol
        if (isEspanol){
            //Arreglo que contiene los nombre s en espanool de los meses del año
            ...
            //Verifica si el año es mayor de 1999
    ...
    public static String formateaFecha(String fecha) {
        ...
        if (fecha.trim().length()>12){
        	seg = fecha.substring(12,14);
        }
        String milseg = "000";
        if (fecha.trim().length()>14){
        	milseg = fecha.substring(14);
        }
       
        
        // Formatea a formato SYBASE MM/DD/YYYY HH:MM
        //fechaEvento = mes + '/' + dia + '/' + anio + " " + hora + ":" + min;
        fechaEvento = anio + '-' + mes + '-' + dia + " " + hora + ":" + min + ":" +seg; //+ "." +milseg ;
        
        //debug("fechaEvento: " + fechaEvento);
