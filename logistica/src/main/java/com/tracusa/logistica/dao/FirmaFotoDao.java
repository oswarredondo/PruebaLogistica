...
import com.tracusa.logistica.interfase.dao.IFirmaFotoDao;
...
public class FirmaFotoDao extends JdbcDaoSupport implements IFirmaFotoDao {
	...
	private static final Logger logger = LoggerFactory.getLogger(FirmaFotoDao.class);
	...
	public int insert(AttachmentDTO obj) throws Exception {
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource, keyHolder, new String[] { "identificador" });
