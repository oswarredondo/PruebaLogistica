...
public class UsuarioDTO implements Serializable{
	...
	//Datos del login del usuario de PDV cuando la 
    //Sesion es invocada desde PDV
    String login_autodoc;
    String estado_p;
    int estatus;
    boolean isAuto_pdv=false;
    //Contiene el convenio que se esta solicitando para la autodoc del usuario
    //Desde el PDV
    int idconvenio=-1;  
    ...
    public EntidadDTO entidad = new EntidadDTO();
    public OrganizacionDTO organizacion = new OrganizacionDTO();
    public CuentasDTO cuenta = new CuentasDTO();
    ...
    private int nivelPuesto; // 100=Asesor/Ejecutivo de Cuenta,
			     // 101=Gerente/Gerente Comercial. ,
			     // 102=Director/Direcci�n de ENV�A,103: Director
			     // General
	...
	/**Indica que tipo de3 interfaz selecciono el usuario para la parte de la 
     aplicaci�n IETWEB, en caso de ser null despliega la hora de estilo por defautl*/
    private String interfaz="o";
    
    public UsuarioDTO(String login, String password,String desEmpresa, int perfil){
        setLogin(login);
     ...
     * datos correctos solamente tendr� 3 oportunidades
     */
     ...
     * (A) Activo<br>
     * (B) Baja<br>
     * Por omisi�n cuando se crea un registro de usuario deber� activarse su
    ...
    /**
     * Contiene el identificador de la ubicaci�n del usuario
     */
     ...
     * @param estado
     */
    public UsuarioDTO(String idUsuario,String estado ){
     ...
     * @param login
     */
    public UsuarioDTO(String idUsuario,int perfil,int ubicacion,String nombre,
    ...
    /**
     *  Devuelve los datos del usuarios en una sesi�n para que se pueda
     ...
     * @param login
     */
    public UsuarioDTO(String idUsuario,String nombre,String login ){
     ...
     * @param login
     */
    public UsuarioDTO(String idUsuario,String perfil,String ubicacion,String nombre,
    String ap_paterno,String ap_materno, String num_imss,String telefono,
    String email,String estado,String login ){
     ...
     * @param centrocosto1
     */
    public UsuarioDTO(String idUsuario1,String perfil1,String ubicacion1,String nombre,
    String ap_paterno,String ap_materno, String num_imss,String telefono,
    ...
    public boolean opcionAsignadaPerfiles(String opcion) {
	if (this.perfiles!=null){
	    PerfilOpcionDTO obj =null;
	        for (int i=0;i<this.perfiles.size(); i++) {
	            obj = (PerfilOpcionDTO)this.perfiles.get(i);
	            if (opcion.equals( obj.getWindowId()) ){
	        	return true;
	            }
		}
	}
    ...
    /** Getter for property desperfil.
     * @return Value of property desperfil.
     *
     */
	...
	public void setEstatus(String estatus) {
		...
		if (estatus.trim().toUpperCase().equals("A")){
			this.estatus = 1;
		}else{
			this.estatus = 0;
		}
	...
	public boolean isActivo() {
		if (this.estatus == 0) return false;
		return true;
	}
	...
	public void setNivelPuesto(String nivelPuesto) {
		try{
			this.nivelPuesto = Integer.parseInt(nivelPuesto);
		}catch(Exception e){
	...
	/**
	 * @return the login_autodoc
	 */
	public String getLogin_autodoc() {
	    return login_autodoc;
	}

	/**
	 * @param login_autodoc the login_autodoc to set
	 */
	public void setLogin_autodoc(String login_autodoc) {
	    this.login_autodoc = login_autodoc;
	}

	/**
	 * @return the isAuto_pdv
	 */
	public boolean isAuto_pdv() {
	    return isAuto_pdv;
	}

	/**
	 * @param isAuto_pdv the isAuto_pdv to set
	 */
	public void setAuto_pdv(boolean isAuto_pdv) {
	    this.isAuto_pdv = isAuto_pdv;
	}
	
	public void setAuto_pdv(String isAuto_pdv) {
	    isAuto_pdv = (isAuto_pdv==null) || (isAuto_pdv.trim().isEmpty())? "false":isAuto_pdv.trim().toLowerCase();
	    try{
		  this.isAuto_pdv = Boolean.parseBoolean(isAuto_pdv);
	    }catch(Exception e){
		this.isAuto_pdv =false;
	    }
	...
	/**
	 * @param estado_p the estado_p to set
	 */
