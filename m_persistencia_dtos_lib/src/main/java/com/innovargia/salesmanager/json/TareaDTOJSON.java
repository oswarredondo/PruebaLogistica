 ...
 *
 */
public class TareaDTOJSON {
	private static final Logger logger = LoggerFactory
			.getLogger(TareaDTOJSON.class);

	private List<TareaDTO> proxiArray;
	private TareaDTO registro;

	/**
	 * @return the data
	 */
	public List<TareaDTO> getData() {
		if (this.proxiArray==null){
			proxiArray = new ArrayList<TareaDTO>();
		}
		return proxiArray;
	}
	 ...
	 */
	public void setData(List<TareaDTO> data) {
	...
	public void runJSONParser(InputStream is) {
		try {
			...
			TareaDTOJSON objs = gson.fromJson(r, TareaDTOJSON.class);
	 ...
	 */
	public void setRegistro(TareaDTO registro) {
