 ...
 *
 */
public class ServicioDTOJSON {
	private static final Logger logger = LoggerFactory
			.getLogger(ServicioDTOJSON.class);

	private List<ServicioDTO> proxiArray;
	private ServicioDTO registro;
	...
	public List<ServicioDTO> getData() {
		if (this.proxiArray==null){
			proxiArray = new ArrayList<ServicioDTO>();
		}
		return proxiArray;
	}
	...
	public void runJSONParser(InputStream is) {
		try {
			...
			ServicioDTOJSON objs = gson.fromJson(r, ServicioDTOJSON.class);
	 ...
	 * @return the registro
	 */
	public ServicioDTO getRegistro() {
		return registro;
	}
	 ...
	 */
	public void setRegistro(ServicioDTO registro) {
