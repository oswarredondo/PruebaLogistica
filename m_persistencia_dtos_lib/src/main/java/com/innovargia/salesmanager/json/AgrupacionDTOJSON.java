 ...
 *
 */
public class AgrupacionDTOJSON {
	private static final Logger logger = LoggerFactory
			.getLogger(AgrupacionDTOJSON.class);

	private List<AgrupamientoDTO> proxiArray;
	private AgrupamientoDTO registro;

	/**
	 * @return the data
	 */
	public List<AgrupamientoDTO> getData() {
		if (this.proxiArray==null){
			proxiArray = new ArrayList<AgrupamientoDTO>();
		}
		return proxiArray;
	}
	 ...
	 */
	public void setData(List<AgrupamientoDTO> data) {
	...
	public void runJSONParser(InputStream is) {
		try {
			...
			AgrupacionDTOJSON objs = gson.fromJson(r, AgrupacionDTOJSON.class);
	 ...
	 * @return the registro
	 */
	public AgrupamientoDTO getRegistro() { 
		return registro;
	}
	 ...
	 */
	public void setRegistro(AgrupamientoDTO registro) {
