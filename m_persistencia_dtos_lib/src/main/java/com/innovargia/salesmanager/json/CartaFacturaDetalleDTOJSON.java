 ...
 *
 */
public class CartaFacturaDetalleDTOJSON {
	private static final Logger logger = LoggerFactory
			.getLogger(CartaFacturaDetalleDTOJSON.class);

	private List<CartaFacturaDetalle> proxiArray;
	private CartaFacturaDetalle registro;

	/**
	 * @return the data
	 */
	public List<CartaFacturaDetalle> getData() {
		if (this.proxiArray==null){
			proxiArray = new ArrayList<CartaFacturaDetalle>();
		}
		return proxiArray;
	}
	 ...
	 */
	public void setData(List<CartaFacturaDetalle> data) {
	 ...
	 * 
	 */
	public CartaFacturaDetalleDTOJSON() {
	...
	public void runJSONParser(InputStream is) {
		try {
			...
			CartaFacturaDetalleDTOJSON objs = gson.fromJson(r, CartaFacturaDetalleDTOJSON.class);
	 ...
	 * @return the registro
	 */
	public CartaFacturaDetalle getRegistro() { 
		return registro;
	}
	 ...
	 */
	public void setRegistro(CartaFacturaDetalle registro) {
