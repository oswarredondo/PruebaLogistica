 ...
 *
 */
public class TarifaRowMapper implements RowMapper<TarifaDTO>{

	/**
	 * 
	 */
	public TarifaRowMapper() {
	...
	public TarifaDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		obj.setPreciocitas(ResultSetUtils.getRSFloat("preciocitas", rs)); 
		obj.setPrecioevidencia(ResultSetUtils.getRSFloat("precioevidencia", rs)); 
		FIN CAMBIO */
