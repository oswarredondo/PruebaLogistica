...
@Repository
public class OficinaControlDAO  extends JdbcDaoSupport implements IOficinaControlDAO {
	...
	@Autowired
	public OficinaControlDAO(DataSource dataSource) {
	...
	final String  sql_ = "SELECT identificador, idoficinacontrol as clave, "
			+ "descripcion, nombre, estatus  FROM caoficinacontrol ";

	@Override
	public void insert(CatalogoDTO catalogo) throws Exception {
		String query = "INSERT INTO caoficinacontrol(idoficinacontrol,descripcion,estatus,nombre) " +
			       "VALUES(:clave, :descripcion, :estatus, :nombre)";
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource,
					keyHolder, new String[] { "idoficinacontrol" });
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE caoficinacontrol SET  idoficinacontrol= :clave,"
				+ "nombre = :nombre, descripcion= :descripcion WHERE " +
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE caoficinacontrol SET estatus= :estatus WHERE " +
			       " identificador = :identificador";
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM caoficinacontrol WHERE " +
			       " identificador = :identificador";
	...
	public CatalogoDTO get(CatalogoDTO catalogo) throws Exception {
		String sql = sql_ + " WHERE idoficinacontrol="+ catalogo.getIdentificador();
		try {
