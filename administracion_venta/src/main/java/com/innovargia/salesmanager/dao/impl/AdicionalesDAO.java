...
@Repository
public class AdicionalesDAO extends JdbcDaoSupport implements  IAdicionalesDAO {
	...
	@Autowired
	public AdicionalesDAO(DataSource dataSource) {
	...
	public void insert(CatalogoDTO catalogo) throws Exception {
		...
		String query = "INSERT INTO caadicional(idadicional, descripcion, precio, tipo,tipoincremento) " +
			       "VALUES(:clave,:descripcion, :precio, " + tipo+ ",:tipoincremento)";
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		...
		String query = "UPDATE caadicional SET idadicional= :clave, "
				+ "tipoincremento=:tipoincremento, descripcion= :descripcion,"
				+ "precio= :precio, tipo=" + tipo+" WHERE " +
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE caadicional SET estatus= :estatus WHERE " +
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM caadicional WHERE " +
			       " identificador = :identificador";
