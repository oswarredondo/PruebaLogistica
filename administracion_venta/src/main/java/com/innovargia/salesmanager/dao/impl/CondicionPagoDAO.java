...
@Repository
public class CondicionPagoDAO  extends JdbcDaoSupport implements  ICondicionesPagoDAO {
	
	private static final Logger logger = LoggerFactory
			.getLogger(AdicionalesDAO.class);

	final String  sql_ = "SELECT identificador,idcondicionpago as clave,"
			+ " descripcion, estatus FROM cacondicionpago ";
	
	private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	private JdbcTemplate jdbcTemplate;

	@Autowired
	public CondicionPagoDAO(DataSource dataSource) {
	...
	public void insert(CatalogoDTO catalogo) throws Exception {
		String query = "INSERT INTO cacondicionpago(idcondicionpago,descripcion,estatus) " +
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource,
					keyHolder, new String[] { "idcondicionpago" });
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE cacondicionpago SET  idcondicionpago= :clave, descripcion= :descripcion WHERE " +
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE cacondicionpago SET estatus= :estatus WHERE " +
			       " identificador = :identificador";
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM cacondicionpago WHERE " +
			       " identificador = :identificador";
	...
	public CatalogoDTO get(CatalogoDTO catalogo) throws Exception {
		String sql = sql_ + " WHERE idcondicionpago="+ catalogo.getIdentificador();
		try {
