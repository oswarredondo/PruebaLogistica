 ...
 */
@Repository
public class DescuentoAdicionalDAO extends JdbcDaoSupport implements IDescuentoAdicionalDAO {

	private static final Logger logger = LoggerFactory
			.getLogger(DescuentoAdicionalDAO.class);

	private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	private JdbcTemplate jdbcTemplate;
	final String  sql_ = "SELECT * FROM cadescuentoadicional ";

	@Autowired
	public DescuentoAdicionalDAO(DataSource dataSource) {
	...
	public void insert(ModalidadDescuentoDTO obj) throws Exception {
		String query = "INSERT INTO cadescuentoadicional(idadicional,iddescuento) ) " +
			       "VALUES(:idadicional,:iddescuento)";
	...
	public void delete(ModalidadDescuentoDTO obj) throws Exception {
		String query = "DELETE FROM cadescuentoadicional  WHERE  idadicional = :idadicional AND iddescuento=:iddescuento ";
