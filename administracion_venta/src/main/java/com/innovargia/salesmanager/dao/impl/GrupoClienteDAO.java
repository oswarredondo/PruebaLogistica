 ...
 */
@Repository
public class GrupoClienteDAO   extends JdbcDaoSupport implements IGrupoClienteDAO{
	...
	final String  sql_ = "SELECT identificador,idgrupocliente as clave,"
			+ "	descripcion,nombre,estatus FROM cagrupocliente ";
	 ...
	 */
	@Autowired
	public GrupoClienteDAO(DataSource dataSource) {
	...
	public void insert(CatalogoDTO catalogo) throws Exception {
		String query = "INSERT INTO cagrupocliente(idgrupocliente,nombre,descripcion,estatus) " +
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource,
					keyHolder, new String[] { "idgrupocliente" });
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE cagrupocliente SET  idgrupocliente= :clave,"
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE cagrupocliente SET estatus= :estatus WHERE " +
			       " identificador = :identificador";
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM cagrupocliente WHERE " +
			       " identificador = :identificador";
	...
	public CatalogoDTO get(CatalogoDTO catalogo) throws Exception {
		String sql = sql_ + " WHERE idgrupocliente="+ catalogo.getIdentificador();
		try {
