 ...
 */
@Repository
public class FormaPagoDAO  extends JdbcDaoSupport implements IFormaPagoDAO {
	private static final Logger logger = LoggerFactory
			.getLogger(AdicionalesDAO.class);
	
	private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
	private JdbcTemplate jdbcTemplate;
	final String  sql_ = "SELECT identificador,idformapago as clave,descripcion,estatus FROM caformapago ";
	/**
	 * 
	 */
	@Autowired
	public FormaPagoDAO(DataSource dataSource) {
	...
	public void insert(CatalogoDTO catalogo) throws Exception {
		String query = "INSERT INTO caformapago(idformapago,descripcion,estatus) " +
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource,
					keyHolder, new String[] { "idformapago" });
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE caformapago SET idformapago= :clave,  descripcion= :descripcion WHERE " +
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE caformapago SET estatus= :estatus WHERE " +
			       " identificador = :identificador";
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM caformapago WHERE " +
			       " identificador = :identificador";
	...
	public CatalogoDTO get(CatalogoDTO catalogo) throws Exception {
		String sql = sql_ + " WHERE idformapago="+ catalogo.getIdentificador();
		try {
