...
@Repository
public class PoblacionPagoDAO  extends JdbcDaoSupport implements IPoblacionPagoDAO {
	...
	@Autowired
	public PoblacionPagoDAO(DataSource dataSource) {
	...
	final String  sql_ = "SELECT identificador,idpoblacionpago as clave,"
			+ "descripcion,nombre,estatus  FROM capoblacionpago ";


	@Override
	public void insert(CatalogoDTO catalogo) throws Exception {
		String query = "INSERT INTO capoblacionpago(idpoblacionpago,nombre,descripcion,estatus) " +
		...
		try {
			this.namedParameterJdbcTemplate.update(query, parameterSource,
					keyHolder, new String[] { "idpoblacionpago" });
	...
	public void update(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE capoblacionpago SET  idpoblacionpago= :clave,nombre= :nombre, descripcion= :descripcion WHERE " +
	...
	public void updateEstatus(CatalogoDTO catalogo) throws Exception {
		String query = "UPDATE capoblacionpago SET estatus= :estatus WHERE " +
			       " identificador = :identificador";
	...
	public void delete(CatalogoDTO catalogo) throws Exception {
		String query = "DELETE FROM capoblacionpago WHERE " +
			       " identificador = :identificador";
	...
	public CatalogoDTO get(CatalogoDTO catalogo) throws Exception {
		String sql = sql_ + " WHERE idpoblacionpago="+ catalogo.getIdentificador();
		try {
