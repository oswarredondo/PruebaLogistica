...
import com.innovargia.salesmanager.mappers.PerfilOpcionRowMapper;
...
public class PerfilOpcionUsuarioDAO extends JdbcDaoSupport  implements IPerfilOpcionUsuarioDAO {
	...
	/*private String sqlopcion =
			" SELECT b.*,catsistemamodulo.descripcion AS descripcion_modulo FROM catsistemamodulo LEFT OUTER JOIN (" +
			"		SELECT a.*,catsistemamoduloopcion.desripcion AS desc_opcion FROM ( " +
			"			SELECT caperfil.identidad,caperfil.idorganizacion,idsistema,idmodulo,caperfil.idperfil," +
			"			nivel,descripcion AS descipcion_perfil,caPerfilopcion.idopcion" +
			"			FROM caperfil LEFT OUTER JOIN caPerfilopcion ON caperfil.idperfil=caPerfilopcion.idperfil " +
			"			) a LEFT OUTER JOIN catsistemamoduloopcion ON  a.idmodulo= catsistemamoduloopcion.idmodulo " +
			"		WHERE a.idmodulo= catsistemamoduloopcion.idmodulo AND a.idopcion= catsistemamoduloopcion.idopcion " +
			"	) b ON catsistemamodulo.idmodulo = b.idmodulo WHERE   b.idsistema=catsistemamodulo.idsistema ";*/
	
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#getPerfiles(com.innovargia.salesmanager.dtos.UsuarioDTO, boolean)
	 */
	@Override
	public List<PerfilOpcionDTO> getPerfiles(UsuarioDTO usuario,boolean onlyActive) throws Exception {
		
		String sql = "SELECT * FROM caperfil WHERE identidad=" + usuario.entidad.getIdentidad()+
				" AND idorganizacion=" + usuario.organizacion.getIdorganizacion() ;
		if (onlyActive){
			 sql += " AND estatus='A'" ;
		}
		return 	jdbcTemplate.query(sql, new PerfilOpcionRowMapper());
	...
	public List<PerfilOpcionDTO> getOpcionesPerfil(String idperfil,
		...
		String sql = "select * from  viewsistemamoduloopcion where idsistema='" + idsistema+"' and idopcion";
		if (!isSeleccionados){
			sql +=  "  NOT  ";
		}
		sql += " IN ( select idopcion from caperfilopcion where idPerfil='" +idperfil + "' AND identidad=" +
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#getOpcionesPerfilAccesoWin(com.innovargia.salesmanager.dtos.UsuarioDTO, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#delete(com.innovargia.salesmanager.dtos.PerfilOpcionDTO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#updatePerfil(com.innovargia.salesmanager.dtos.PerfilOpcionDTO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#updateEstado(com.innovargia.salesmanager.dtos.PerfilOpcionDTO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#deleteOpcionPerfil(com.innovargia.salesmanager.dtos.PerfilOpcionDTO)
	 */
	@Override
	public void deleteOpcionPerfil(PerfilOpcionDTO perfil) throws SQLException{

		
		String sql = "DELETE FROM caperfilopcion WHERE identidad=" + perfil.getIdentidad() + " AND idorganizacion=" + perfil.getIdorganizacion() +
				" AND idperfil='"+ perfil.getIdperfil() + "' AND idopcion='"+ perfil.getIdopcion() +"'";
	...
	/* (non-Javadoc)
	 * @see com.innovargia.salesmanager.dao.impl.IPerfilOpcionUsuarioDAO#addOpcionPerfil(com.innovargia.salesmanager.dtos.PerfilOpcionDTO)
	 */
	@Override
