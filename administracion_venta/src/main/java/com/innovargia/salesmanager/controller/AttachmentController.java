...
public class AttachmentController {
	...
	//public ModelAndView upload(
		...
		if (usuario == null) {
			...
			// Evaluar que el archivo no venga vacío
			
				try {
					InputStream inputstream=null;
					if (!archivo_procesar.isEmpty()) {
						//mensaje = "Archivo vacio";
						// Leemos el archivo y lo transformamos en líneas
					...
					mensaje = "Se salvo la información";
					modelMap.put("success", true);
	 ...
	 * @return file found
	 */
	@RequestMapping(value = "/viewArchivo")
