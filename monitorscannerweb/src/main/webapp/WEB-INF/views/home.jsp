  ...
  <div class="wrapper">
  	<div class="google-header-bar  centered">
  		<div class="header content clearfix">
 		 	<img alt="En" class="logo" src="resources/images/logo_tracusa.png">    
 		</div>
  	</div>
  		<div class="main content clearfix">
			<div class="banner">
				<h1>Monitor de Procesamiento LOPs</h1>
			</div>
			  <div class="card signin-card">
				<img id="profile-img" class="profile-img" src="resources/images/User_trs.png" alt="">
