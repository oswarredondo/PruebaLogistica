...
$.extend({
    ...
    fileDownload: function (fileUrl, options) {
        ...
        var settings = $.extend({
            ...
            //Panel donde se pondra el mensaje
            panel: null
        ...
        var internalCallbacks = {
            ...
            onPrepare: function (url) {
                ...
                if (settings.panel) {
                	...
                	if(settings.preparingMessageHtml){
                		...
                		settings.panel.setLoading(settings.preparingMessageHtml);
            ...
            onSuccess: function (url) {
            	...
            	settings.panel.setLoading(false);
            ...
            onFail: function (responseHtml, url, error) {
                ...
                if (settings.failMessageHtml) {
                	mensajeAlert(settings.dialogOptions);
                }
