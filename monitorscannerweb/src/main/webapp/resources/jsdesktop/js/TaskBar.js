    ...
    initComponent: function () {
       ...
       // me.startMenu = new Ext.ux.desktop.StartMenu(me.startConfig);
        ...
        me.items = [
            ...
            /*{
                xtype: 'splitter', html: '&#160;',
                height: 14, width: 10, // TODO - there should be a CSS way here
                cls: 'x-toolbar-separator x-toolbar-separator-horizontal'
            },*/
            me.windowBar,
            {xtype:'label', html:'Sesión de usuario <font color="#04B404"><b>Activa</b></font>', id:'idverificasesionusuario'},
            '-',
            me.quickStart,
            me.tray
        ];
...
Ext.define('Ext.ux.desktop.TrayClock', {
    ...
    timeFormat: ' d/m/Y  g:i A',
        ...
        tpl: '<font color="green"><b>{time}</b></font>',
    initComponent: function () {
        var me = this;
