Ext.define('MyDesktop.form.FormCitaEnvio', {
 extend: 'Ext.form.Panel',
	...
	initComponent: function () {
		...
		this.items= [
				{ xtype: 'datefield', name:'fechachita',fieldLabel: 'Fecha',
					 format: 'd-m-Y', labelWidth: 80, width: 190},
				{ xtype:'timefield',name:'horacita',allowBlank:false,width:80 , format:'H:i'},
			    {  xtype: 'myUpperCaseTextField',fieldLabel: 'Folio',  name: 'folio',allowBlank:false, maxLength:4,width:150}

			];
		
		this.buttons= [
						{  text: 'Salvar', iconCls:'activo',handler:function() {
