 ...
 extend: 'Ext.panel.Panel',
	...
	importar:function(){
		var myscope=this;
		 ...
		 Ext.MessageBox.confirm('Confirmar','Se limpiará la información actual,¿Desea continuar?', 
				 function(id, text){
	       			if ( (id === 'yes')  || (id === 'si') || (id === 'y' ) || (id === 's' ) ){ 
	...
	limpiar:function() {
		var myscope=this;
		 Ext.MessageBox.confirm('Confirmar','¿Desea limpiar la información de la tabla de impresión?', 
				 function(id, text){
	       			if ( (id === 'yes')  || (id === 'si') || (id === 'y' ) || (id === 's' ) ){ 
	       				//myscope.grid_etiquetas.getStore().removeAll();
	       				//depuraCleanUUID(myscope.uuid);
