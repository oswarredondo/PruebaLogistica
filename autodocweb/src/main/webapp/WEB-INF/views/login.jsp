...
<table class="table"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td rowspan="2" bgcolor="#F7F7F7"><table border="0" cellspacing="0" class="tablebusca">
      ...
      <tr>
        <td align="center"><b><font face="verdana" size="4" color="black"><center >
      ...
      <tr>
      <td  colspan="4" >
		        <!-- <center ><span id='forma_login'></span></center-->
		
		        <h5><b style="color:red;text-align:center">${SPRING_SECURITY_LAST_EXCEPTION.message}</b></h5>
		        <form name='f' action="./login" method='POST'> 
		        				<table align="center" >
		        					<tr>
		        						<td>
		        							<input type="text"  
                                	 		class="x-form-field x-form-required-field x-form-text" autocomplete="off" 
											aria-invalid="false" data-errorqtip="" style="width: 80%;" name="username"  
											placeholder="Usuario"   style="text-transform:uppercase" />
		        						</td>
		        					</tr>
		        					<tr>
		        						<td>
		        							<input type="password"  
                                	 		class="x-form-field x-form-required-field x-form-text" autocomplete="off" 
											aria-invalid="false" data-errorqtip="" style="width: 80%;"
                                			name="password" placeholder="Password"  style="text-transform:uppercase" />
		        						</td>
		        					</tr>
		        					<tr>
		        						<td>
		        							<button type="submit" style="width: 80%;" >Acceso Usuario</button>
		        						</td>
		        					</tr>
		        				</table>
		        				<div>
                            	...
                            	<hr style="background-color: #ffffff; opacity: .4;">
                            	...
                            	<div class="row">
                                	<div class="col-6">
                                   	 	<!--<button type="button" class="btn btn-primary px-4"  ng-click="validaLogin(user)">Acceso Usuario</button> -->
