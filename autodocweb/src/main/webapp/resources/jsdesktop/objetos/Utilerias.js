var version_app ="V3.4.0-20181007";
var nombre_sistema ='Generación y Rastreo de Mensajer&iacute;a';
var siglas_sistema = 'GERMEN-TRA';
var submodulo = 'Auto Documentaci&oacute;n-WEB';
...
function creaVentanaEspera(mensaje){
	 if (mensaje==undefined){
		 mensaje= 'Procesando la información, espere...';
	 }
...
function setValorFormaField(field_name, forma, new_value){
	var fields =forma.getForm().getFields( ) ;
	 setValueFormField(field_name, fields, new_value);
}
