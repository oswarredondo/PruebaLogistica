Ext.define('MyDesktop.form.FormManifiestoRuta', {
	...
	initComponent : function(config) {
		...
		this.items=[
		  {xtype : 'hidden', name:"_csrf", value:vt},
		            ...
		            {
			    		xtype: 'textfielduppercase',fieldLabel: fieldForzoso(field_nombre_ruta),
			    		id: 'nombreruta',name: 'nombreruta',width:200,labelWidth: 100,
			    		allowBlank: false,maxLength:1,maxLength:50
			    	},
			    	 
			    	{
			    		xtype: 'textfielduppercase',fieldLabel: fieldForzoso(field_nombre_chofer),
			    		name: 'nombrechofer',	
			    		id: 'nombrechofer',	labelWidth: 100,	allowBlank: false,width: 200,
			    		maxLength:1,maxLength:50
			    	},
			    	{
			    		xtype: 'textfielduppercase',fieldLabel: fieldForzoso(field_telono_chofer),
			    		name: 'telefonochofer',
			    		id: 'telefonochofer',	labelWidth: 100,allowBlank: false,width: 200,
			    		maxLength:1,maxLength:50
			    	},
			    	{
			    		xtype: 'textfielduppercase',fieldLabel: fieldForsozo(field_empresa),
			    		name: 'empresatranportista',
			    		id: 'empresatranportista',	labelWidth: 100,allowBlank: false,width: 200,
			    		maxLength:1,maxLength:50
			    	},
			    	{
			    		xtype: 'textfielduppercase',fieldLabel: fieldForzoso(field_placas),name: 'placas',
			    		id: 'placas',	labelWidth: 100,allowBlank: false,width: 200,
			    		maxLength:1,maxLength:30
			    	},
			    	{
			    		xtype: 'textfielduppercase',fieldLabel: fieldForzoso(field_tipo_vehiculo),
			    		name: 'tipovehiculo',
	        ...
	        this.buttons= [
	            {text   : titulo_btn_gnerar_manifiesto,handler: this.submitForm, scope:this},
	...
	submitForm:function(){
		...
		if(!fp.isValid()){
		 ...
		 //Manda la informaci�n al visor de etiquetas para que despliegue los datos
