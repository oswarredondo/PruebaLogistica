Ext.define('MyDesktop.form.FormConfirmacionOcurre', {
 extend: 'Ext.form.Panel',
    xtype: 'confirmacion-ocurre-form',
    frame: false,
    width: 400,
    layout: 'anchor',
    border: false,
	...
	initComponent: function () {
		...
		this.items= [
		         ...
		         {
	                 	  xtype: 'myUpperCaseTextField',fieldLabel: field_guia,name: 'guia',allowBlank: false,width: 500,
	                 	  enforceMaxLength:true,maxLength:50,  readOnly:this.showReadOnly,
	             },
                 {
               	  xtype: 'datefield',fieldLabel: field_fecha_expira,name: 'fechaexpira',allowBlank: false,
               	  	maxValue: new Date(),width: 300, readOnly:this.showReadOnly, value:new Date()
                 },
                 {
                     xtype: 'timefield',
                     name: 'hora',
                     fieldLabel: field_hora,
                     increment: 30,
                     format:'H:i', 
                     anchor: '100%'
                },
                {
               	  xtype: 'myUpperCaseTextField',fieldLabel: field_recibe,name: 'recibe',allowBlank: false,width: 500,
               	  enforceMaxLength:true,maxLength:50,  readOnly:this.showReadOnly,
                },
                {
                   	...
                   	items: [
                   	        {inputValue: 'ife',boxLabel: 'IFE',checked: true},
                   	        {inputValue: 'licencia',boxLabel: 'LIC. CONDUCIR',checked: true}, 
                	        {inputValue: 'cartilla',boxLabel: 'CARTILLA'},
                	        {inputValue: 'pasaporte',boxLabel: 'PASAPORTE'}
                   	    ]
                   },
                {
                 	  xtype: 'myUpperCaseTextField',fieldLabel: field_numidentificacion,name: 'identificacion',allowBlank: false,width: 500,
                 	  enforceMaxLength:true,maxLength:50,  readOnly:this.showReadOnly,
                }
