Ext.define('MyDesktop.form.FormDevolucionOcurre', {
 extend: 'Ext.form.Panel',
    xtype: 'devolucion-ocurre-form',
    frame: false,
    width: 400,
    layout: 'anchor',
    border: false,
	...
	initComponent: function () {
		...
		this.items= [
		  {xtype : 'hidden', name:"_csrf", value:vt},
                 ...
                 { xtype: 'timefield',name: 'hora',fieldLabel: 
                	 field_hora,increment: 30, format:'H:i',  anchor: '100%' },
	   		      {
	                     xtype: 'combobox', fieldLabel: field_claveexcepcion,  editable :false, name: 'clave',
