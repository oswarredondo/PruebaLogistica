	...
	initComponent: function () {
        ...
        var gridMovimientosHistoria = 
        	Ext.create('MyDesktop.grid.GridMovimientosHistoria',{
        		 title: titulo_historia,layout:'fit', height:300,width:200
        	});
        var gridGuiasPaquetes = 
        	Ext.create('MyDesktop.grid.GridGuiasPaquetes',{
        		 title: titulo_paquete,layout:'fit', height:210,width:200
        	});
		...
		this.items= [
		  {xtype : 'hidden', name:"_csrf", value:vt},
		      {
	                      xtype: 'combobox', fieldLabel: titulo_btn_busqueda,  editable :false, name: 'tipo',
	            ...
	            {  xtype: 'myUpperCaseTextField',fieldLabel: field_patron,  name: 'numcliente',allowBlank:false, maxLength:4,width:150,
