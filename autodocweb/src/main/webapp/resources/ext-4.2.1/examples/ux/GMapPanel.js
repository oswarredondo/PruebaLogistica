...
markers: [{
    ...
    initComponent : function(){
        ...
        if (window.google && window.google.maps){
          ...
          this.buildScriptTag('http://maps.google.com/maps/api/js?key=AIzaSyAB0T8tEHohBEDNgZ12pYMBBcfkA7PyUfM&sensor=false&callback=gmapapiready');
          
         // this.buildScriptTag('http://maps.googleapis.com/maps/api/js?key=AIzaSyDXCoww3ig865QWXw93ipza9fhVIEGwYqk&sensor=false');
        }
