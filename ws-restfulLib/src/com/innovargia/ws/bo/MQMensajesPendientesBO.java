...
import com.innovargia.ws.repo.interfase.bo.IMQMensajesPendientesBO;
 ...
 */
@Service
public class MQMensajesPendientesBO implements IMQMensajesPendientesBO   {
    
    private static final Logger logger = LoggerFactory
		.getLogger(MQMensajesPendientesBO.class);
