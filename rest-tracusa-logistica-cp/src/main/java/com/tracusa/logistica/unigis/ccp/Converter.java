...
// Import this package:
//
//     import com.tracusa.logistica.unigis.ccp.Converter;
//
// Then you can deserialize a JSON string with
//
//     UnigisCCP data = Converter.fromJsonString(jsonString);
...
public class Converter {
    ...
    public static UnigisCCP fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(UnigisCCP obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(UnigisCCP.class);
        writer = mapper.writerFor(UnigisCCP.class);
    }
