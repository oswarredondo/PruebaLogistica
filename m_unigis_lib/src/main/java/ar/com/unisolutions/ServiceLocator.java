...
public class ServiceLocator extends org.apache.axis.client.Service implements ar.com.unisolutions.Service {
    ...
    private java.lang.String ServiceSoap_address = "https://cloud.unigis.com/Tracusa/mapi/soap/logistic/service.asmx";
    ...
    public ar.com.unisolutions.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ar.com.unisolutions.ServiceSoapStub _stub = new ar.com.unisolutions.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "https://cloud.unigis.com/Tracusa/mapi/soap/logistic/service.asmx";
    ...
    public ar.com.unisolutions.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ar.com.unisolutions.ServiceSoap12Stub _stub = new ar.com.unisolutions.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ar.com.unisolutions.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ar.com.unisolutions.ServiceSoapStub _stub = new ar.com.unisolutions.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (ar.com.unisolutions.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ar.com.unisolutions.ServiceSoap12Stub _stub = new ar.com.unisolutions.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://unisolutions.com.ar/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://unisolutions.com.ar/", "ServiceSoap"));
            ports.add(new javax.xml.namespace.QName("http://unisolutions.com.ar/", "ServiceSoap12"));
        }
