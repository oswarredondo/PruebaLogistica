...
public interface IRotulacionEtiquetasDatosBO {
	...
	public  List<EtiquetaRotulacionDTO> importFie(MultipartFile fileBean)throws Exception;
	public void deleteRegistrosUUID(EtiquetaRotulacionDTO etiqueta) throws Exception;
	 ...
	 public int insertVentaAutoDoc(VentaDTO venta,List<DetalleVenta> lista_detalleventa,
		 List<Integer> ids_json_generdas, UsuarioDTO usuario,String json_data, int cantidad)
				 throws Exception; 
		...
		void validaRegistrosImport(EtiquetaRotulacionDTO eti);
