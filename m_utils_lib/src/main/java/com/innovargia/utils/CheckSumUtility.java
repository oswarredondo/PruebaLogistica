...
public class CheckSumUtility {
	...
	/***
	 * Crea un identificador utilizando CRC32 para obtener un numero único de
	 * acuerdo a la sesión del usuario y la fecha en que esta realizando la
	 * acción, se envia la cadena y se le aplica el algoritmo de CRC32
	 * 
	 ...
	 */
	 ...
	 public static String encryptaPassWordSHA1(String password) throws Exception{
