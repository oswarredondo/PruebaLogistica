...
public class EmailAttachmentSender {
	 ...
	 public static void main(String[] args) {
	        ...
	        String to = "amoruaro@gmail.com"; 
	        String from = "sistlogist@gmail.com";
	        ...
	        props.put("mail.smtp.user", "sistlogist@gmail.com");
			props.put("mail.smtp.password", "sistlogist2011");
			props.put("mail.smtp.host",  "smtp.gmail.com");
			props.put("mail.smtp.mail.sender","amoruaro@gmail.com");  
	        ...
	        try {
	            ...
	            setFileAsAttachment(msg, "C:/opt/adminsales/documentospdf/COTIZACION-7_20142302010001.pdf");
	            msg.saveChanges();
	            bus.sendMessage(msg, address);
