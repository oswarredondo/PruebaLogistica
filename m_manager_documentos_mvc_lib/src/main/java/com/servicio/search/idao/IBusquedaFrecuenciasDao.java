...
public interface IBusquedaFrecuenciasDao {
	 ...
	 * 
	 * @param cp C�digo postal que se desea consultar
	 ...
	 *  en caso de no encontrar informaci�n
	 */
    ...
    public List<CoberturaEnrutamientoTranladoDTO> getFrecuenciasOriDesCobertura(
	    String cporigen, String cpdestino, String idgarantia,
	    UsuarioDTO usuario) throws SQLException ;
}