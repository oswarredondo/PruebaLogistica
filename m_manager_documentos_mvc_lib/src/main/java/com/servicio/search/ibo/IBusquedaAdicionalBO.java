...
public interface IBusquedaAdicionalBO {
	...
	public abstract List<AdicionalDTO> getRegistrosDisponiblesConvenio(int idconvenio, 
			String uuid, int iddregistrodatos ) throws Exception;;
